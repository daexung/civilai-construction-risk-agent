# 전체 표 수: 2326개 · A+B 비율: 21.3% · 파싱 불량(X) 비율: 32.8%

# 표준품셈 전 페이지 표 유형 조사

PDF 982쪽을 조사했다. 실행 시간 246.39초.
...
A/B를 하나 이상 가진 절: 448개 / 1058개 절.
레코드가 있는 표: 2316개. 0레코드 표: 10개. uncertain 과반 표: 752개. 오류 쪽: 0개.
장별×유형 및 절별 전체 수치는 `results/summary.json`에 있다.

## PDF 185~214쪽

`find_tables()` 검출 표 84개 중 레코드가 있는 표 83개, uncertain 행 포함 표 33개, 0레코드 표 1개.
